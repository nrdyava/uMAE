...
from src.models.MultiDecoderQuantileMSEViTMAELinearProbe import MultiDecoderQuantileMSEViTMAELinearProbe
...
if __name__ == "__main__":
    ...
    pretrained_model = MultiDecoderQuantileMSEViTMAELightning.load_from_checkpoint(pretrained_model_ckpt_path)
    linear_probe_model = MultiDecoderQuantileMSEViTMAELinearProbe(pretrained_model, num_classes=100, learning_rate=config['optimizer']['lr'])
